                    ...
                    <td colspan="4">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td class="threadtd">
                                    <span style="font-size: 20px;"><?php echo $fetch['username']; ?></div> <?php echo (($fetchUser['u_id'] == $fetch['u_id'] && isset($_SESSION[$uniqueCode]))? '<a href="' . $website_url . 'p/editprofile">[Edit]</a>' : ''); ?></span><br />
                    ...
                    <table style="width: 100%;" border=1>
                        ...
                        <tr>
                            ...
                            <td style="width: 20%;"><div class="profileSpan">
                                <?php echo ((isset($fetchDetails['reputation'])? $fetchDetails['reputation'] : '0')); ?> <?php echo (($fetchUser['u_id'] != $fetch['u_id'] && isset($_SESSION[$uniqueCode]))? '<a href="' . $website_url . 'p/profile?userid=' . $fetch['u_id'] . '&giveReputation">[Give reputation]</a>' : ''); ?>
